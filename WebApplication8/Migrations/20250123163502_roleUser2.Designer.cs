...
namespace WebApplication8.Migrations
{
    ...
    [Migration("20250123163502_roleUser2")]
    partial class roleUser2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplication8.Models.Role", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WebApplication8.Models.User", b =>
                {
                    b.HasOne("WebApplication8.Models.Role", "Role")
                        .WithMany()
                        .HasForeignKey("RoleId");

                    b.HasOne("WebApplication8.Models.Role", null)
                        .WithMany("Users")
